define([
    ...
    "Array/mapMatrix",
    "Array/flatten"
  ], function(Seed, ggss, numericjs, Canvas){
  console.log(numericjs);
  ...
  var AC = Seed.extend({
    ...
    "findEigenValues" : function(){
      var a = this.matrix,
          ...
          sumR = this.sumR,
          v_jj = [],
          p_ij = (this.p_ij = a.mapMatrix(function(cell, i ,j){ 
            
            if(isNaN(cell/total)){
              //console.log();
              throw("Problem with cell "+i+","+j+" : "+cell);
            }
